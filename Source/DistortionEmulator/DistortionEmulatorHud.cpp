...
ADistortionEmulatorHud::ADistortionEmulatorHud()
{
	static ConstructorHelpers::FObjectFinder<UFont> Font(TEXT("/Engine/EngineFonts/RobotoDistanceField"));
	HUDFont = Font.Object;
}

void ADistortionEmulatorHud::DrawHUD()
{
	Super::DrawHUD();
	...
	if (bWantHUD == true)
	{
		...
		ADistortionEmulatorPawn* Vehicle = Cast<ADistortionEmulatorPawn>(GetOwningPawn());
